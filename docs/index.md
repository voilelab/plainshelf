...
not retained. A Markdown import keeps embedded illustrations in
`sources/{source-id}/assets/`, linked where they appeared; only the ones the
shelf cannot store are dropped and counted. Everything on the shelf stays
