...
func backdateSources(t *testing.T, env *apiTestEnv, bookID string) {
	t.Helper()
...
func fingerprintSources(t *testing.T, env *apiTestEnv, wantStatus int) taskChainSubmitResponse {
	t.Helper()
